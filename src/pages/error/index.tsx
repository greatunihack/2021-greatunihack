        ...
        <Box className={classes.outerWrapper}>
            <Grid container className={classes.innerWrapper}>
                <Grid item xs={12} md={6} className={classes.root}>
                    ...
                    <Typography className={classes.message}>{message ?? "Something Went Wrong"}</Typography> 
                </Grid>
                <Hidden smDown>
            ...
            <Hidden smDown>
                <div className={classes.footer}>
                    <Typography className={classes.tip}><strong>Hackathon Tip {index + 1}:</strong> {tip}</Typography>
                </div>
            </Hidden>
        </Box>
    );
